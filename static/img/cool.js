        ...
        // };
			...
			if(window.innerWidth<=480){
                ...
                for (var i = 0; i < nLen; i++) {
                    // console.log(i);
                    narrators[i].style['width'] = 45 + 'vw';
                    narrators[i].style['height'] =  45 + 'vw';
                    cNarrators[i].style['width'] = 46 + 'vw';
                    cNarrators[i].style['height'] = 46 + 'vw';
                    lNarrators[i].style['width'] = 60 + 'vw';
