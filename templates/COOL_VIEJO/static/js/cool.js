 ...
 var goToSection = function(to) {
        ...
        */
        ...
        for (var i = 0; i < nLen; i++) {
            // console.log(i);
            narrators[i].style['width'] = (winInnerSize[0] * widthPercent) + 'px';
            narrators[i].style['height'] = (winInnerSize[1] * heightPercent) + 'px';
            cNarrators[i].style['width'] = (winInnerSize[0] * (widthPercent + 0.02)) + 'px';
            cNarrators[i].style['height'] = (winInnerSize[1] * (heightPercent + 0.02)) + 'px';
