...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.content_text'
        db.delete_column(u'news_Manager_post', 'content_text')

        # Adding field 'Post.content'
        db.add_column(u'news_Manager_post', 'content',
                      self.gf('django.db.models.fields.TextField')(default='Llaala'),
                      keep_default=False)

        # Adding field 'Post.user'
        db.add_column(u'news_Manager_post', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_Manager.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.content_text'
        db.add_column(u'news_Manager_post', 'content_text',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Deleting field 'Post.content'
        db.delete_column(u'news_Manager_post', 'content')

        # Deleting field 'Post.user'
        db.delete_column(u'news_Manager_post', 'user_id')
