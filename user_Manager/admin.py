...
class userAdmin(UserAdmin):
    ...
    list_display = ('username', 'birthday', 'is_admin')
    list_filter = ('is_admin',)
    fieldsets = (
        ('User and Password', {'fields': ('username', 'password')}),
        ('Informacion Personal', {'fields': ('birthday','first_name','last_name','picture','bio',)}),
